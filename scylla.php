...
<?php
    ...
    if (!isset($_COOKIE[$histroy])) {
        ...
        if (count($savedItemArray) <= 4) {
            array_push($savedItemArray, 'Scylla');
...
<body>
        <div class="row">
            <div class="cassandraPro">
                <h1>Scylla Cluster</h1>
                <div class="cassandraImage">
                    <img src = "./images/scylla1.png">
                </div>
                <discription>This is the discription for scylla product:This is scylla cluster with 10 nodes service</discription>
            </div>
        </div>
</body>
